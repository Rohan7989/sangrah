...
//       <TextInput style={styles.input} placeholder="Website/App Name" value={name} onChangeText={setName} />
//       <View style={styles.row}><Text>Free?</Text><Switch value={isFree} onValueChange={setIsFree} /></View>
//       <View style={styles.row}><Text>Sign-in Required?</Text><Switch value={requiresSignIn} onValueChange={setRequiresSignIn} /></View>
//       <View style={styles.row}>
//         <Button title="Website" onPress={() => setPlatform('Website')} />
//         <Button title="App" onPress={() => setPlatform('App')} />
//         <Button title="Both" onPress={() => setPlatform('Both')} />
//       </View>
